...
public class ConvertInputStreamToStringBenchmark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println();
        System.out.println("apacheToInputStream : " + test.apacheToInputStream());
        System.out.println("jdkBufferedReader : " + test.jdkBufferedReader());
        System.out.println("guavaReaderInputStream : " + test.guavaReaderInputStream());
        System.out.println("jdkScanner : " + test.jdkScanner());
        System.out.println("jdkJava8 : " + test.jdkJava8());
        System.out.println("jfkJava8parallel : " + test.jfkJava8parallel());
        System.out.println();
